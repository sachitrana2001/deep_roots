...
export default function Home(): JSX.Element {
  ...
  return (
    <main>
      ...
      <section className="relative bg-cover bg-center bg-[url('/assets/bg2.png')]  w-full px-5 py-10 lg:h-[400px] lg:px-24">
        <div className="absolute inset-0 bg-primary opacity-75"></div>
        <div className="relative z-10">
          <p className="text-4xl text-white text-center font-semibold md:text-3xl">
            BIGGEST BRANDS COLLAB WITH DEEPROOTS
          </p>
          <ImageSlider
            slideClass="p-20"
            class="h-[250px] m-10 bg-white shadow-xl rounded-xl md:h-[250px]"
