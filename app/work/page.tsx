export default function page() {
  return (
    <main>
      <section className="w-[100%] h-[300px] bg-center bg-no-repeat overflow-hidden z-1 bg-[url('/assets/bg3.jpeg')] bg-cover lg:h-screen">
        <div className="w-full h-full flex flex-col  justify-center items-center bg-green-700/30 backdrop-brightness-50">
