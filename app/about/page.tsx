    ...
    <main>
      <section className="w-[100%] h-[300px] bg-center bg-no-repeat overflow-hidden z-1 bg-[url('/assets/bg2.png')] bg-cover lg:h-[400px]">
        <div className="w-full h-full flex flex-col  justify-center items-center bg-blue-600/30 backdrop-brightness-75">
          ...
          <span className="text-white text-2xl md:text-4xl text-center">
            We Are Deep Roots
          </span>
      ...
      <section className="w-[100%] px-5 my-20 lg:h-[400px] lg:px-24 lg:my-20">
        <p className="text-4xl text-center font-semibold  md:text-5xl">
          BIGGEST BRANDS TRUST DEEPROOTS
        </p>
        <ImageSlider
          slideClass="p-20 "
          class="h-[250px] m-10 shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] rounded-xl md:h-[250px]"
